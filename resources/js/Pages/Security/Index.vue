    ...
    <div class="space-y-6">
        ...
        <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="lg:col-span-2 flex justify-end">
                <button type="submit" :disabled="form.processing" class="px-6 py-2.5 bg-emerald-600 text-white rounded-xl font-bold hover:bg-emerald-700 transition-all shadow-sm active:scale-95 disabled:opacity-50 flex items-center gap-2">
