    ...
    <div class="min-h-screen relative flex items-center justify-center overflow-hidden font-sans selection:bg-emerald-500 selection:text-white bg-[#558678]">
        ...
        <div class="relative z-20 w-full max-w-[420px] bg-white/95 backdrop-blur-xl border border-white/50 rounded-[2rem] shadow-[0_20px_70px_-10px_rgba(0,0,0,0.4)] p-6 sm:p-8 m-4 max-h-[calc(100vh-2rem)] overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            ...
            <div class="flex flex-col items-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-800 tracking-tight text-center">Reset Password</h2>
                <p class="text-gray-500 text-xs sm:text-sm mt-1 text-center px-2">Enter your new password below.</p>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                >
                    <div v-if="form.errors.email || form.errors.password || form.errors.password_confirmation" class="mb-4 bg-red-50 border-l-4 border-red-500 p-4 rounded-r-xl shadow-sm">
                ...
                <div class="group">
                    <div class="relative transition-all duration-300">
                        ...
                        <!-- Toggle Show/Hide -->
                        <div class="absolute inset-y-0 right-0 pr-3.5 flex items-center cursor-pointer text-gray-400 hover:text-gray-600 transition-colors" @click="showConfirmPassword = !showConfirmPassword">
