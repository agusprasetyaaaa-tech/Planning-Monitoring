...
<template>
    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-3xl shadow-sm border border-gray-100 font-sans">
        <div class="flex items-center justify-between mb-8">
            <h2 class="text-[18px] leading-[25px] font-semibold text-[rgb(15,23,42)]">Edit User</h2>
        ...
        <form @submit.prevent="submit" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <!-- Password -->
                <div>
                     <label class="block text-[14px] leading-[17px] font-medium text-[rgb(30,41,59)] mb-2">Password <span class="text-xs font-normal text-gray-400">(Leave blank to keep)</span></label>
